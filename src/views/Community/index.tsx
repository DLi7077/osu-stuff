    ...
    >
      <Section theme={theme} title="Community" subtitle="How it started">
        <>
          ...
          <br />
          osu! was made by Dean (peppy) Herbert, an ex Microsoft .NET developer.
          It is open source and have been in development since 2007.
          <br />
          <br />
          ...
          well as many community contributions to continuously improve the game.
          <br />
          <br />
          Compared to other rhythm games, osu! is community driven with a strong
          focus on user content. Thanks to the beatmap editior he made, users
          are able to create their own beatmaps and share them with others,
          which is the main game content.
          <br />
          <br />
          Although osu! is a non-profit free to play game, their main profit
          comes from donations through "supporter tags".
          <br />
          osu!supporter tags costs 4$ a month and comes with a bunch of in-game
          perks.
          <br />
          <br />
          <blockquote>
